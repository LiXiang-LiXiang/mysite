...
def article_titles(request, username=None):
    ...
    if username:
        return render(request, "article/list/author_articles.html", {"articles":articles, "page":current_page, "userinfo":userinfo,})
...
def article_detail(request, id, slug):
    ...
    # print(similar_articles[0],similar_articles[0].same_tags)
    # print(similar_articles[1], similar_articles[1].same_tags)
    # print(similar_articles[2], similar_articles[2].same_tags)
